                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${pageContext.request.contextPath}/assets/images/users/1.jpg" alt="user">
                                            </div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${pageContext.request.contextPath}/assets/images/users/2.jpg" alt="user">
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${pageContext.request.contextPath}/assets/images/users/3.jpg" alt="user">
                                            </div>
                                            <div class="chat-content">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        <p>And is full of waffle to It has multiple paragraphs and is full of waffle to
                                            ...
                                            comment..</p>
                                        <img src="${pageContext.request.contextPath}/assets/images/background/img4.jpg" class="img-fluid">
                                    </div>
                                </div>
