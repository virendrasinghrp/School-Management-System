...
<head>
    ...
    <link href="${contextPath}/assets/libs/toastr/build/toastr.min.css" rel="stylesheet">
...
<body>
                                ...
                                <div class="modal fade" id="Modal3" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="${contextPath}/assets/images/background/img5.jpg" width="100% ">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Close</button>
    ...
    <!-- this page js -->
    <script src="${contextPath}/assets/libs/toastr/build/toastr.min.js"></script>
    <script>
        $(function () {
            // Success Type
