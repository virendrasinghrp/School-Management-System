...
<head>
    ...
    <!-- Custom CSS -->
    <link href="${contextPath}/assets/libs/flot/css/float-chart.css" rel="stylesheet">
...
<body>
    ...
    <!-- this page js -->
    <script src="${contextPath}/assets/libs/chart/matrix.interface.js"></script>
    <script src="${contextPath}/assets/libs/chart/excanvas.min.js"></script>
    <script src="${contextPath}/assets/libs/flot/jquery.flot.js"></script>
    <script src="${contextPath}/assets/libs/flot/jquery.flot.pie.js"></script>
    <script src="${contextPath}/assets/libs/flot/jquery.flot.time.js"></script>
    <script src="${contextPath}/assets/libs/flot/jquery.flot.stack.js"></script>
    <script src="${contextPath}/assets/libs/flot/jquery.flot.crosshair.js"></script>
    <script src="${contextPath}/assets/libs/chart/jquery.peity.min.js"></script>
    <script src="${contextPath}/assets/libs/chart/matrix.charts.js"></script>
    <script src="${contextPath}/assets/libs/chart/jquery.flot.pie.min.js"></script>
    <script src="${contextPath}/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="${contextPath}/assets/libs/chart/turning-series.js"></script>
    <script src="${contextPath}/dist/js/pages/chart/chart-page-init.js"></script>
</body>
