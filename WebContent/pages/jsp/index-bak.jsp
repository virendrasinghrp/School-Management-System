...
<head>
    ...
    <meta name="keywords"
        content="wrappixel, admin dashboard, html css dashboard, web dashboard, bootstrap 5 admin, bootstrap 5, css3 dashboard, bootstrap 5 dashboard, Matrix lite admin bootstrap 5 dashboard, frontend, responsive bootstrap 5 admin template, Matrix admin lite design, Matrix admin lite dashboard bootstrap 5 dashboard template"></meta>
    <meta name="description"
        content="Matrix Admin Lite Free Version is powerful and clean admin dashboard template, inpired from Bootstrap Framework"></meta>
    <meta name="robots" content="noindex,nofollow"></meta>
    <title>Lorem Ipsum Academy</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="${pageContext.request.contextPath}/assets/images/favicon.png"></link>
    <!-- Custom CSS -->
    <link href="${pageContext.request.contextPath}/assets/libs/flot/css/float-chart.css" rel="stylesheet"></link>
    <!-- Custom CSS -->
    <link href="${pageContext.request.contextPath}/dist/css/style.min.css" rel="stylesheet"></link>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/index.jsp">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="${pageContext.request.contextPath}/assets/images/loremIpsum.png" alt="homepage" class="light-logo" />
                    ...
                    <ul class="navbar-nav float-start me-auto">
                        ...
                        <li class="nav-item search-box"> <a class="nav-link waves-effect waves-dark"
                            ...
                            <form class="app-search position-absolute">
                                <input type="text" class="form-control" placeholder="Search &amp; enter"></input> <a
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="${pageContext.request.contextPath}/charts.jsp" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span
                                    class="hide-menu">Charts</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="${pageContext.request.contextPath}/widgets.jsp" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span
                                    class="hide-menu">Widgets</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="${pageContext.request.contextPath}/tables.jsp" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="${pageContext.request.contextPath}/pages-buttons.jsp" aria-expanded="false"><i
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/icon-material.jsp" class="sidebar-link"><i
                                            class="mdi mdi-emoticon"></i><span class="hide-menu"> Material Icons
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/icon-fontawesome.jsp" class="sidebar-link"><i
                                            class="mdi mdi-emoticon-cool"></i><span class="hide-menu"> Font Awesome
                                            Icons </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="${pageContext.request.contextPath}/pages-elements.jsp" aria-expanded="false"><i class="mdi mdi-pencil"></i><span
                                    class="hide-menu">Elements</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i
                                    class="mdi mdi-move-resize-variant"></i><span class="hide-menu">Addons </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/index2.jsp" class="sidebar-link"><i
                                            class="mdi mdi-view-dashboard"></i><span class="hide-menu"> Dashboard-2
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/pages-gallery.jsp" class="sidebar-link"><i
                                            class="mdi mdi-multiplication-box"></i><span class="hide-menu"> Gallery
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/pages-calendar.jsp" class="sidebar-link"><i
                                            class="mdi mdi-calendar-check"></i><span class="hide-menu"> Calendar
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/pages-invoice.jsp" class="sidebar-link"><i
                                            class="mdi mdi-bulletin-board"></i><span class="hide-menu"> Invoice
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/pages-chat.jsp" class="sidebar-link"><i
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/authentication-login.jsp" class="sidebar-link"><i
                                            class="mdi mdi-all-inclusive"></i><span class="hide-menu"> Login </span></a>
                                </li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/authentication-register.jsp" class="sidebar-link"><i
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/error-403.jsp" class="sidebar-link"><i
                                            class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Error 403
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/error-404.jsp" class="sidebar-link"><i
                                            class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Error 404
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/error-405.jsp" class="sidebar-link"><i
                                            class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Error 405
                                        </span></a></li>
                                <li class="sidebar-item"><a href="${pageContext.request.contextPath}/error-500.jsp" class="sidebar-link"><i
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    <div class="p-2"><img src="${pageContext.request.contextPath}/assets/images/users/1.jpg" alt="user" width="50"
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="${pageContext.request.contextPath}/assets/images/users/4.jpg" alt="user" width="50"
                                            class="rounded-circle"></img></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="${pageContext.request.contextPath}/assets/images/users/5.jpg" alt="user" width="50"
                                            class="rounded-circle"></img></div>
                                    <div class="comment-text w-100">
                                    ...
                                    <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="customCheck"></input>
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="${pageContext.request.contextPath}/assets/images/users/1.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Steave"></img></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="${pageContext.request.contextPath}/assets/images/users/2.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Jessica"></img></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="${pageContext.request.contextPath}/assets/images/users/3.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Priyanka"></img></li>
                                                <li class="assignee"><img class="rounded-circle" width="40"
                                                        src="${pageContext.request.contextPath}/assets/images/users/4.jpg" alt="user"
                                                        data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Selina"></img></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="customCheck1"></input>
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="customCheck2"></input>
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="customCheck3"></input>
                                        ...
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="customCheck4"></input>
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${pageContext.request.contextPath}/assets/images/users/1.jpg" alt="user"></img>
                                            </div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${pageContext.request.contextPath}/assets/images/users/2.jpg" alt="user"></img>
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${pageContext.request.contextPath}/assets/images/users/3.jpg" alt="user"></img>
                                            </div>
                                            <div class="chat-content">
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        <p>And is full of waffle to It has multiple paragraphs and is full of waffle to
                                            ...
                                            comment..</p>
                                        <img src="${pageContext.request.contextPath}/assets/images/background/img4.jpg" class="img-fluid"></img>
                                    </div>
                                </div>
